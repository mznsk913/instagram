...
class HomeViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    //コメント送信ボタンが押された時に呼ばれるメソッドを作る
    //登録用のデータを作ってupdatedataを作る
    @objc func cmtButton(_ sender: UIButton, forEvent event: UIEvent) {
        ...
        let CommentViewData = self.storyboard?.instantiateViewController(withIdentifier: "comment") as! CommentViewData
        CommentViewData.postData = postData
        self.present(CommentViewData, animated: true, completion: nil)
